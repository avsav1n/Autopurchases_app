    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Required. 254 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=254, unique=True, verbose_name='Электронная почта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='Необязательное поле. Ссылка на пользователя, который использует указанный адрес.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rtoken', models.UUIDField(default=uuid.UUID('6a030a9f-12db-44c9-944e-8f663806de01'), unique=True, verbose_name='Токен сброса пароля')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shops_roles', to=settings.AUTH_USER_MODEL, verbose_name='Управляющие')),
